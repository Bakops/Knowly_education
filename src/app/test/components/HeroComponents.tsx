...
export default function HeroHeader() {
  return (
    <div className="text-[#f4f4f4] font-sans text-left p-4 md:p-10 rounded-lg max-w-[1300px] mx-auto my-8 md:my-16 md:text-center">
      <section className="">
                ...
                <div>
                    <h1 className="text-4xl text-left font-bold text-gray-800 sm:text-6xl lg:text-7xl">
                        <div className="relative text-left inline-flex">
                            ...
                            <h1 className="relative text-4xl font-bold text-gray-800 sm:text-6xl lg:text-7xl">Knowly :</h1>
                        </div>
                    ...
                    <button className="w-full sm:w-auto bg-[#cccccc] text-[#1a1a1a] px-5 py-3 text-sm sm:text-base rounded-md hover:opacity-90 cursor-pointer relative flex align-middle justify-center gap-3">
                        Contactez-nous
