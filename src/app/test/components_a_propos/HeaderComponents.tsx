    ...
    /></Link>
                ...
                <nav className={`w-full ml-20 bg-gray-800 flex-col items-center ${isMenuOpen ? "opacity-0" : "hidden"} md:flex md:flex-row md:w-auto`}>
                    <ul className="flex flex-col md:flex-row md:gap-8">
                        ...
                        <li><Link href="/test/page/lessons" className="menu-link font-poppins font-bold text-[16px]">Leçons</Link></li>
                        <li><Link href="/test/page/a_propos" className="menu-link menu-link-active font-poppins font-bold text-[16px]">À propos</Link></li>
