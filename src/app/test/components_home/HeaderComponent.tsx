            ...
            <div className={`fixed inset-0 bg-gray-800 text-white transform ${isMenuOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-200 z-10`}>
                <div className="p-6">
                    ...
                    <ul className="flex flex-col justify-end gap-10 ml-5">
                        <li><a href="#" className="menu-link text-2xl uppercase menu-link-active">Accueil</a></li>
                        <li><a href="#" className="menu-link text-2xl uppercase">Portfolio</a></li>
                        <li><a href="#" className="menu-link text-2xl uppercase">À propos</a></li>
                        <li><a href="#" className="menu-link text-2xl uppercase">Contact</a></li>
                    </ul>
                   {/* Social media icons at the end, hidden on mobile */}
